    ...
    public class MagicLightProbes : MonoBehaviour
    {
        ...
        private void GetWorkPath(string dataPath)
        {
            Thread findShader = new Thread(new ThreadStart(() =>
            {
                ...
                //Debug.LogFormat("<color=yellow>MLP:</color> Work path found - " + workPath);
            }));
        ...
        public void RecalculateColorThereshold()
        {
            ...
            lightProbesVolumeCalculatingRoutine = RecalculateColorThresholdRealtime(cullingByEquivalentColor, colorTreshold);
