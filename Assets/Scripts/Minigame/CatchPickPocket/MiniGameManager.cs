...
public class MiniGameManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            StartCoroutine(Wait(5.0f)); // 5초 후 시작.
        }
    ...
    private void SetPickPocket()
    {
        ...
        pickPocket.transform.position = rau.transform.position + new Vector3(0, 0, distance);//new Vector3(rauPos.x , rauPos.y, rauPos.z + distance);// 소매치기 위치 초기화. (== 소매치기 시작 위치.)
