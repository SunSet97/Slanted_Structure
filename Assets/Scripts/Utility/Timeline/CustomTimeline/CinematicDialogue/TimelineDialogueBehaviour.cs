...
namespace Utility.Timeline.CustomTimeline.CinematicDialogue
{
    [Serializable]
    public class TimelineDialogueBehaviour : PlayableBehaviour
    {
        ...
        public void UpdateTrack(string clipName, double clipStartTime)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    foreach (var dialogue in dialogueData.dialogueElements)
                    {
        ...
        public override void OnBehaviourPlay(Playable playable, FrameData info)
        {
            ...
            if (!isAuto)
            {
                ...
                DialogueController.Instance.AddDialogueEndAction(() => { playable.GetGraph().Play(); });
                dialogueJson = null;
            }
            else
            {
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            var dialogue = dialogueData.dialogueElements.First(item =>
